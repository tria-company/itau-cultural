...
/**
 * Studio · Organização · Mídia.
 *
 * A PAREDE MORA AQUI AGORA, e não mais empilhada embaixo da ficha do Produtor.
 *
 * Até 2026-08-27 esta tela era o segundo andar de `/studio/midia/`: quem abria a pauta
  ...
  return (
    <SuperficieSoWeb>
      <SeparacaoDaOrganizacao
        ...
        rotaNova="/studio/midia/"
        rotuloDaRotaNova="Abrir Mídia no Studio"
      />
      <StudioOrgMidia
